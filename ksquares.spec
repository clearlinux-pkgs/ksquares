...
Source0  : https://download.kde.org/stable/release-service/24.08.2/src/ksquares-24.08.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.08.2/src/ksquares-24.08.2.tar.xz.sig
...
%setup -q -n ksquares-24.08.2
cd %{_builddir}/ksquares-24.08.2
pushd ..
cp -a ksquares-24.08.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1728582817
mkdir -p clr-build
pushd clr-build
