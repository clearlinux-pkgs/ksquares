...
Version  : 21.12.3
Release  : 37
URL      : https://download.kde.org/stable/release-service/21.12.3/src/ksquares-21.12.3.tar.xz
Source0  : https://download.kde.org/stable/release-service/21.12.3/src/ksquares-21.12.3.tar.xz
Source1  : https://download.kde.org/stable/release-service/21.12.3/src/ksquares-21.12.3.tar.xz.sig
...
%prep
%setup -q -n ksquares-21.12.3
cd %{_builddir}/ksquares-21.12.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1646524085
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/ksquares-21.12.3/LICENSES/GFDL-1.2-or-later.txt %{buildroot}/usr/share/package-licenses/ksquares/7697008f58568e61e7598e796eafc2a997503fde
cp %{_builddir}/ksquares-21.12.3/LICENSES/GPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/ksquares/3e8971c6c5f16674958913a94a36b1ea7a00ac46
pushd clr-build
%make_install
popd
%find_lang ksquares
